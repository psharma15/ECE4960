function memplus = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MEMPLUS = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   MEMPLUS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   memplus = importfile('memplus.mtx', 3, 126152);
%
%    See also TEXTSCAN.
